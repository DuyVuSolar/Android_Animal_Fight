package com.kuemiin.animalfight.data.repository
...
//            clone.isSelected = clone.localeCode == locale
    ...
    private val languagesSingAlong = listOf(
        Language(title = "English", alpha2 = "us", localeCode = "en", variant = "US", isSelected = true),
        Language(title = "Tiếng Việt", alpha2 = "vn", localeCode = "vi"),
        Language(title = "Thailand", alpha2 = "th", localeCode = "th"),
        Language(title = "Spain", alpha2 = "es", localeCode = "es"),
        Language(title = "French", alpha2 = "fr", localeCode = "fr"),
        Language(title = "Hindi", alpha2 = "hi", localeCode = "hi"),
        Language(title = "China", alpha2 = "cn", localeCode = "cn"),
    )

    fun getListLanguageSingAlong() : ArrayList<Language>{
        val res = arrayListOf<Language>()
        languagesSingAlong.map {
            val clone = it.copy()
//            clone.isSelected = clone.localeCode == locale
            res.add(clone)
        }
