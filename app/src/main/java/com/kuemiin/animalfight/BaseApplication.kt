package com.kuemiin.animalfight
...
import com.kuemiin.animalfight.ui.activity.main.GlobalOverlayTimerManager
import com.kuemiin.animalfight.utils.LocaleHelper.dLocale
import com.kuemiin.animalfight.utils.MaxUtils
import com.kuemiin.animalfight.utils.MaxUtils.TYPEX
import com.kuemiin.animalfight.utils.MaxUtils.logFirebaseEvent
import com.kuemiin.animalfight.utils.extension.initBaseApplication
        ...
        remoteConfig.fetchAndActivate()
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    MaxUtils.setTimeReloadCollap(
                        this,
                        remoteConfig.getLong("timeReloadCollap").toInt()
                    )
                    ...
                    val booleanParams = listOf(
                        ...
                        "isShowingInterIntro" to MaxUtils.ISSHOWINGINTERINTRO,
                        ...
                        "isShowingNativeFullGuide" to MaxUtils.ISSHOWINGNATIVE_FULLGUIDE,
                        "isShowingNativePermission" to MaxUtils.ISSHOWINGNATIVE_PERMISSION,
                        "isCheckClick" to MaxUtils.ISCHECKCLICK,
                        "isCheckClickSplash" to MaxUtils.ISCHECKCLICKSPLASH,
                        "isCheckClickIntro" to MaxUtils.ISCHECKCLICKINTRO,
...
//        }
    ...
    companion object {
        ...
        @Volatile
        lateinit var instance: com.kuemiin.animalfight.BaseApplication

        @JvmStatic
        fun getAppInstance(): com.kuemiin.animalfight.BaseApplication = instance
