...
import com.kuemiin.animalfight.utils.refresh.Util.dip2px
import com.kuemiin.animalfight.utils.refresh.Util.limitValue
...
class MaterialFoodView @JvmOverloads constructor(
    ...
    com.kuemiin.animalfight.utils.refresh.MaterialHeadListener {
    ...
    private val listener: com.kuemiin.animalfight.utils.refresh.MaterialHeadListener? = null
