...
import com.kuemiin.animalfight.ui.activity.main.MainActivity2
import com.kuemiin.animalfight.ui.activity.main.MainActivity3
import com.kuemiin.animalfight.ui.activity.main.MainActivity4
...
object MaxUtils {
    ...
    fun loadAdmob(activity: Activity, nextScreenListener: NextScreenListener) {
        ...
        InterstitialAd.load(
            activity, INTER_ID, adRequest, object : InterstitialAdLoadCallback() {
                    ...
                    if (getBoolean(activity, ISSHOWINGNATIVE_FULL, true)) {
                        if (isCheck(activity)) {
                            activity.startActivity(
                                Intent(
                                    activity, MainActivity2::class.java
                                )
                            )
                        }
                    }
    ...
    fun showAdsWithCustomCount(
        activity: Activity, nextScreenListener: NextScreenListener
    ) {
        MaxUtils.nextScreenListener = nextScreenListener
        nextScreenListener.nextScreen()//TODO duyvd
...
//        }
    ...
    fun loadAdmobSplash(
        ...
        InterstitialAd.load(
            activity, INTER_ID_SPLASH, adRequest, object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    activity.logFirebaseEvent("ad_inter_load_fail")
...
//
//        InterstitialAd.load(
//            activity, INTER_ID_INTRO, adRequest, object : InterstitialAdLoadCallback() {
//                override fun onAdFailedToLoad(adError: LoadAdError) {
//                    nextScreenListener.nextScreen()
//                    _showLoading.update { false }
//                    activity.logFirebaseEvent("ad_inter_load_fail")
...
//            })
    ...
    // region interstitial guide
    fun loadAdmobGuide(activity: Activity, nextScreenListener: NextScreenListener) {
        MaxUtils.nextScreenListener = nextScreenListener
        nextScreenListener.nextScreen()
...
////                    }
//
//                    if (getBoolean(activity, ISSHOWINGNATIVE_FULLGUIDE, true)) {
//                        if (isCheck(activity)) {
//                            activity.startActivity(
//                                Intent(activity, MainActivity2::class.java)
//                            )
//                        }
//                    }
//
...
//            })
    ...
    fun loadNative123(
        ...
        val adLoader = AdLoader.Builder(mActivity, key).forNativeAd { unifiedNativeAd ->
            ...
            val layoutMap = mapOf(
                ...
                6 to R.layout.full_screen_native_ads_intro,
            )

            val layoutRes = layoutMap[typeScreen] ?: R.layout.native_admob_ad_intro
...
//        if (!getBoolean(
//                mActivity, ISSHOWINGNATIVE_SPLASH, true
//            ) && !isCheck(mActivity)
//        ) {
//            containerShimmer.apply {
//                stopShimmer()
...
//
//        val adLoader =
//            AdLoader.Builder(mActivity, AD_UNIT_ID_NATIVE_SPLASH).forNativeAd { unifiedNativeAd ->
//                unifiedNativeAd.setOnPaidEventListener { adValue ->
//                    logRevCC(
//                        mActivity, "native", adValue.valueMicros.toDouble()
//                    )
...
//                val nativeAdView =
//                    mActivity.layoutInflater.inflate(layoutRes, null) as NativeAdView
//
...
//                    super.onAdClicked()
//                    loadNativeSplash(
//                        mActivity, rootView, containerShimmer, frameLayout, nextScreenListener
//                    )
//                }
//            }).withNativeAdOptions(
//                NativeAdOptions.Builder()
...
//        adLoader.loadAd(AdRequest.Builder().build())
    ...
    fun loadNativePermission(
        ...
        if (!getBoolean(
                mActivity, ISSHOWINGNATIVE_PERMISSION, true
            )
        ) {
            containerShimmer.apply {
                stopShimmer()
    ...
    fun loadAd(context: Activity) {
        ...
        AppOpenAd.load(
            context, AOA_RESUME_ID, request, object : AppOpenAd.AppOpenAdLoadCallback() {
    ...
    fun loadAdSplash(
        ...
        val request = AdRequest.Builder().build()
        AppOpenAd.load(
            context, AOA_SPLASH_ID, request, object : AppOpenAd.AppOpenAdLoadCallback() {
                override fun onAdLoaded(ad: AppOpenAd) {
                    appOpenAdSplash = ad
    ...
    // region event
    fun isCheck(activity: Context): Boolean =
        getBoolean(activity, ISCHECKORG, true) && "Organic" != getString(
            activity,
            "attribution",
            "Organic"
        )
    ...
    fun logRevCC(activity: Context, adFormat: String, adValue: Double) {
        ...
        paramsAdRevenueSDK.putDouble(
            FirebaseAnalytics.Param.VALUE, (adValue / 1000000)
        )
...
//
    ...
    const val AD_UNIT_ID_NATIVE_NOTIFY = "ca-app-pub-2622117118790581/3669518390"
    const val AD_UNIT_ID_NATIVE_GUIDE = "ca-app-pub-2622117118790581/5038440388"
    const val AD_UNIT_ID_NATIVE_PERMISSION = "ca-app-pub-2622117118790581/9610727326"
...
//    const val AD_UNIT_ID_NATIVE_FULL = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_FULLSPLASH = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_FULLINTRO = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_FULLBREAK = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_SPLASH = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_NOTIFY = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_GUIDE = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_PERMISSION = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_INTRO1 = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_INTRO2 = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_INTROFULL = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_COLLAP = "ca-app-pub-3940256099942544/2247696110"
//    const val AD_UNIT_ID_NATIVE_BOTTOM = "ca-app-pub-3940256099942544/2247696110"
    ...
    const val ISSHOWINGNATIVE_FULLGUIDE = "ISSHOWINGNATIVE_FULLGUIDE"
    ...
    const val ISSHOWINGINTERINTRO = "ISSHOWINGINTERINTRO"
    ...
    const val ISCHECKCLICK = "ISCHECKCLICK"
    const val ISCHECKCLICKSPLASH = "ISCHECKCLICKSPLASH"
    const val ISCHECKCLICKINTRO = "ISCHECKCLICKINTRO"
    ...
    const val COUNTCLICK = "COUNTCLICK"

    //endregion
    fun setCountClick(activity: Context) {
        val sharePreference =
            activity.getSharedPreferences(SharedPreferences_Name, Context.MODE_PRIVATE)
        sharePreference.edit { putInt(COUNTCLICK, getCountClick(activity) + 1) }
    }

    fun getCountClick(activity: Context): Int {
