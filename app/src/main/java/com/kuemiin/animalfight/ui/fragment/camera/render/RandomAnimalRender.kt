 ...
 * @date 2018-05-25
 */
class RandomAnimalRender(context: Context, val widthRender : Int, val typeFilter : String) : QuestionRender(context) {
    ...
    init {
        ...
        component.src = "${CanvasTiktokFileFilter.getFilterFormatFile("typeFilter")}/${CanvasTiktokFileFilter.folderAnimal}"
