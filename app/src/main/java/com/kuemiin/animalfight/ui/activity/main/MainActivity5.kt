        ...
        val adLoader = AdLoader.Builder(this, MaxUtils.AD_UNIT_ID_NATIVE_FULLBREAK)
            ...
            .withAdListener(object : AdListener() {
                ...
                override fun onAdLoaded() {
                    super.onAdLoaded()
                    if (MaxUtils.getBoolean(this@MainActivity5, ISCHECKCLICK, false)) {

                        binding.ivClose.visibility = View.VISIBLE
                        binding.ivClose2.visibility = View.VISIBLE
                        if (MaxUtils.getCountClick(this@MainActivity5) % MaxUtils.getCount(this@MainActivity5) == 0) {
                            ...
                            binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
                                width = dpToPx(this@MainActivity5, 24)
                                height = dpToPx(this@MainActivity5, 24)
                            }
                        }

                        if (incrementCount) MaxUtils.setCountClick(this@MainActivity5)
                    } else {
                        binding.ivClose.visibility = View.VISIBLE
                        binding.ivClose2.visibility = View.VISIBLE
                        binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
