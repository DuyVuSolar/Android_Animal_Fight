...
class TryThisViewModel @Inject constructor(
    ...
    fun initVideo(playerView: PlayerView) = viewModelScope.launch{
        ...
        val fileRaw = if(typeEffect == Bitmap2025QuizFilter.EFFECT_SING_A_SONG) R.raw.video_demo_sing_a_song else if(typeEffect == Bitmap2025QuizFilter.EFFECT_TIKTOK_VOICE) R.raw.video_demo_the_voice else R.raw.video_demo_animal_challage
