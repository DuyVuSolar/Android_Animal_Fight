        ...
        val adLoader = AdLoader.Builder(this, MaxUtils.AD_UNIT_ID_NATIVE_FULL)
            ...
            .withAdListener(object : AdListener() {
                ...
                override fun onAdLoaded() {
                    super.onAdLoaded()
                    if (MaxUtils.getBoolean(this@MainActivity2, ISCHECKCLICK, false)) {
                        binding.ivClose.visibility = View.VISIBLE
                        binding.ivClose2.visibility = View.VISIBLE
                        if (MaxUtils.getCountClick(this@MainActivity2) % MaxUtils.getCount(this@MainActivity2) == 0) {
                            ...
                            binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
                                width = dpToPx(this@MainActivity2, 24)
                                height = dpToPx(this@MainActivity2, 24)
                            }
                        }
                        if (incrementCount) MaxUtils.setCountClick(this@MainActivity2)
                    } else {
                        binding.ivClose.visibility = View.VISIBLE
                        binding.ivClose2.visibility = View.VISIBLE
                        binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
