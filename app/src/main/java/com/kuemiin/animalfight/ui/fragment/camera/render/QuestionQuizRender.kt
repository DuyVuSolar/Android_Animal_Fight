 ...
 * @date 2018-05-25
 */
class QuestionQuizRender(context: Context, val widthRender : Int, val typeFilter : String, val language : String) : QuestionRender(context) {
...
//        heightRender = (widthRender * 0.306f).toInt()
        ...
        component.src = "${CanvasTiktokFileFilter.getFilterFormatFile("typeFilter")}/${CanvasTiktokFileFilter.folderSingWord}/$language"
