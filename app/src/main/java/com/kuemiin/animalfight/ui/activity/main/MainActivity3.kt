        ...
        val adLoader = AdLoader.Builder(this, MaxUtils.AD_UNIT_ID_NATIVE_FULLSPLASH)
            ...
            .withAdListener(object : AdListener() {
                ...
                override fun onAdLoaded() {
                    super.onAdLoaded()
                    if (MaxUtils.getBoolean(this@MainActivity3, ISCHECKCLICK, false)) {
                        if (MaxUtils.getBoolean(this@MainActivity3, ISCHECKCLICKSPLASH, false)) {
                            binding.ivClose.visibility = View.VISIBLE
                            binding.ivClose2.visibility = View.VISIBLE

                            if (MaxUtils.getCountClick(this@MainActivity3) % MaxUtils.getCount(this@MainActivity3) == 0) {
                                ...
                                binding.ivClose2.updateLayoutParams<ViewGroup.LayoutParams> {
                                    width = dpToPx(this@MainActivity3, 24)
                                    height = dpToPx(this@MainActivity3, 24)
                                }
                            }

                            if (incrementCount) {
                                MaxUtils.setCountClick(this@MainActivity3)
                            }
                        } else {
                            binding.ivClose.visibility = View.VISIBLE
                            binding.ivClose2.visibility = View.VISIBLE
