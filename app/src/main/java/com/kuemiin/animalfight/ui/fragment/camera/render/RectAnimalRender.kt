package com.kuemiin.animalfight.ui.fragment.camera.render
...
import com.kuemiin.animalfight.pose.render.ComponentConvert
 ...
 * @date 2018-05-25
 */
class RectAnimalRender(context: Context, val widthRender : Int, val typeFilter : String) : QuestionRender(context) {

    var heightRender = 0

    init {
        heightRender = (widthRender * 0.625f).toInt()
        val sticker = Sticker()
        sticker.components = ArrayList()
        val component = Component()
        component.duration = 400
        component.src = "${CanvasTiktokFileFilter.getFilterFormatFile("typeFilter")}/${CanvasTiktokFileFilter.folderRetangle}"
