...
import com.kuemiin.animalfight.data.store.DataStoreHelper.Companion.KEY_HAS_SHOW_GUIDE
...
class GuideViewModel @Inject constructor(
    ...
    var listGuide = arrayListOf(
        IntroSplash(
            ...
            R.drawable.bg_permission_notify,
            3,
            true,
            isPerNotification = true
        ),
    ...
    fun navigateToHome() {
        viewModelScope.launch {
            introEventChannel.send(IntroEvent.NavigateToHome)
        }
    }
    ...
    sealed class IntroEvent {
        ...
        object NavigateToHome : IntroEvent()
    }
}