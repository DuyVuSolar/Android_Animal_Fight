package com.kuemiin.animalfight.ui.fragment.trythis
...
import com.kuemiin.animalfight.databinding.FragmentTryThisBinding
                ...
                when (event) {
                    ...
                    TryThisViewModel.Event.NavigateOnClickTryThis -> {
                        if (viewModel.typeEffect == EFFECT_SING_A_SONG) {
                            ...
                            navigateTo(R.id.action_tryThisFragment_to_languageFragment)
                        } else if (viewModel.typeEffect == EFFECT_TIKTOK_VOICE) {
                            requireContext().logFirebaseEvent("click_the_voice_button_try_this")
                            navigateTo(
                                R.id.action_tryThisFragment_to_cameraFragment,
                                CameraFragment.newBundle(viewModel.typeEffect)
                            )
                        } else {
                            requireContext().logFirebaseEvent("click_the_animal_button_try_this")
                            navigateTo(
                                R.id.action_tryThisFragment_to_cameraFragment,
                                CameraFragment.newBundle(viewModel.typeEffect)
                            )
